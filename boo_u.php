...
<body style="background-image: url('Image/background_generic.jpg')";>
    <ul id="H2">
        ...
        <li id="H1" style="float:right;"><a id="H" class="active" href="logout_u.php">LogOut</a></li>
                        ...
                        <center><h1><font color="Yellow">CV of Buwendra Abeysooriya</font></h1></center>
            
       <img src="Image/Buwendra.jpg" >
            <table style="color:white; border-collapse:separate; 
border-spacing:5em;">

<font color="white"><div id="header"></div>
<p id="name">Email : <a href="mailto:buwendra.abesuriya@gmail.com" target="_blank"><p id="email">buwendra.abesuriya@gmail.com</p></a></p>
...
<hr>
          ...
          <footer><a href="boo_u.php" ><img src="Image/top2.png" align="right"></a></footer>
    </body>
</html>