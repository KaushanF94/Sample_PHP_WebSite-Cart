...
<body style="background-image: url('Image/background_generic.jpg')";>
    <ul id="H2">
        ...
        <li id="H1" style="float:right;"><a id="H" class="active" href="logout_u.php">LogOut</a></li>
                        ...
                        <center><h1><font color="Yellow">CV of Devin De Alwis</font></h1></center>
            
       <img src="Image/devin.jpg" >
            <table style="color:white; border-collapse:separate; 
border-spacing:5em;">

<font color="white"><div id="header"></div>
<p id="name">Email : <a href="mailto:devin123@gmail.com" target="_blank"><p id="email">devin123@gmail.com</p></a></p>
...
<hr>
          ...
          <footer><a href="devin_u.php" ><img src="Image/top2.png" align="right"></a></footer>
    </body>
</html>