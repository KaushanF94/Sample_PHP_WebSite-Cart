...
width: 100%; background-image: url('Image/witcherBG.jpg')"><ul id="H2">
        ...
        <li id="H1"><a id="H" href="home.html">HOME</a></li>
        <li id="H1"><a id="H" href="#Shop">SHOP</a></liid="H">
        <li id="H1"><a id="H" href"#games">GAME</a></li>
        <li id="H1" style="float:right;"><a id="H" class="active" href="Aboutus.html">ABOUT US</a></li>
