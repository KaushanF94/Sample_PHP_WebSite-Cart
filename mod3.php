    ...
    <div align="center" style="background-image :url('Image/main.jpg');width:890px;height:242px;margin-left:245px">
        ...
        <div>
          ...
          <br/>
                          ...
                          <table>
                          <tr><td colspan="2"><a hidden href="commentPost.php?Game_ID=<?php echo $Games->Game_ID; ?>"> <input  style="background-color:#09C"  type="submit" name="submit1" value=" Post Comment" class="form-control"></a></td></tr>
                          </table>
          </div>
          <div align="center">
            <p>&#160</p>
